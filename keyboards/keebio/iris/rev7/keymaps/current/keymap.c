...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    KC_NO, KC_TILD, KC_LPRN, KC_LCBR, KC_LBRC,   KC_LT, KC_TRNS,    TO(0), KC_GT,   KC_RBRC, KC_RCBR, KC_RPRN, KC_GRV,  KC_NO,
                                        KC_NO, KC_TRNS, KC_TRNS,    LCTL(KC_LSFT), LALT(KC_LSFT), KC_NO
  ),
  [2] = LAYOUT(
  ...
  [3] = LAYOUT(
     ...
     KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T,                  KC_Y, KC_U, KC_I,  KC_O,  KC_P,  KC_F11,
    KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G,                  KC_H, KC_J, KC_K,  KC_L,  KC_F9, KC_F10,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_F2,    TO(0), KC_N, KC_M, KC_F5, KC_F6, KC_F7, KC_F8,
                           KC_F1, KC_SPC, KC_ENT,    KC_TRNS, KC_F3, KC_F4
  )
};
